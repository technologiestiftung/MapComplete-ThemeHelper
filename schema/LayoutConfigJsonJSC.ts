export default {
  ...
  definitions: {
    ...
    DenominationConfigJson: {
      ...
      required: ["canonicalDenomination"],
    },
      ...
      properties: {
        extraDeleteReasons: {
          ...
          items: {
            ...
            required: ["changesetMessage", "explanation"],
          },
        },
        nonDeleteMappings: {
          description:
    ...
    default_2: {
      ...
      required: ["applicableUnits", "appliesToKey"],
    },
    "Partial<any>": {
      type: "object",
    },
    default_6: {
      ...
      required: ["defaultState", "id", "source"],
    },
    LayerConfigJson: {
      ...
      properties: {
        ...
        syncSelection: {
          ...
          enum: ["global", "local", "no", "theme-only"],
          type: "string",
        },
      },
      required: ["id", "mapRendering", "source"],
    },
    default: {
      type: "object",
      properties: {
